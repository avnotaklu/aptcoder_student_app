...
class ProfileEditPrompt extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        BlocBuilder<ProfileBloc, ProfileStateWithStudent>(
        ...
        BlocBuilder<ProfileBloc, ProfileStateWithStudent>(builder: (context, state) {
          if (state is EditProfileState && label == state.label) {
            if (state is EditProfileState && label == state.label) {
              return Row(
          ...
          return IconButton(
              ...
              onPressed: () {
                context.read<ProfileBloc>().add(EditProfile(label, student));
              });
        })
      ],
    );
